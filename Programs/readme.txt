...
9_3.asm - тоже самое, что и 9_2.asm, но теперь мы не передаем управление оригинльному обработчику, а просто делаем iret (при этом не забыли отправить End-of-Interrupt signal), так что все продолжает работает, а не умирает.
